...
public final class Main {
    ...
    public static void main(String[] args) {
        logHandler.log(textHandler.LOG_SEPARATOR, LogHandler.LogLevel.INFORMATION, false);
        logHandler.log(textHandler.GAME_INIT_STARTED, LogHandler.LogLevel.INFORMATION, false);
